  ...
  <body>
    ...
    <div class="blog-masthead">
      <div class="container">
        <nav class="blog-nav">
          ...
          <a class="blog-nav-item" href="#">Register</a>
    ...
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title">Join us!</h1>
        <p class="lead blog-description">By connecting with us, you will guarantee yourself the latest updates and news for everything <em>code</em>.</p>
      </div>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#">Sign to your account</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.container-fluid -->
    </nav>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <form>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox"> By signup you agree to the terms and conditions*
                        </label>
                    </div>
